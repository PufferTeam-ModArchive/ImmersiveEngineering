...
public class ChemthrowerHandler {
    ...
    /**
     * registers a fluid to be dispersed like a gas. This is only necessary if the fluid itself isn't designated as a
     * gas
     */
    ...
    public abstract static class ChemthrowerEffect {
        ...
        public abstract void applyToEntity(EntityLivingBase target, EntityPlayer shooter, ItemStack thrower,
            Fluid fluid);

        public abstract void applyToBlock(World worldObj, MovingObjectPosition mop, EntityPlayer shooter,
            ItemStack thrower, Fluid fluid);
    }
    ...
    public static class ChemthrowerEffect_Damage extends ChemthrowerEffect {
        ...
        @Override
        public void applyToBlock(World worldObj, MovingObjectPosition mop, EntityPlayer shooter, ItemStack thrower,
            Fluid fluid) {}
    }
    ...
    public static class ChemthrowerEffect_Potion extends ChemthrowerEffect_Damage {
        ...
        public void applyToEntity(EntityLivingBase target, EntityPlayer shooter, ItemStack thrower, Fluid fluid) {
            ...
            if (this.potionEffects != null && this.potionEffects.length > 0)
                for (int iEffect = 0; iEffect < this.potionEffects.length; iEffect++) if (target.getRNG()
                    .nextFloat() < this.effectChances[iEffect]) {
