...
public class ShaderCaseRevolver extends ShaderCase {
    ...
    public ShaderCaseRevolver(String overlayType, int[] colourGrip, int[] colourPrimary, int[] colourSecondary,
        int[] colourBlade, String additionalTexture) {
    ...
    public int getPasses(ItemStack shader, ItemStack item, String modelPart) {
        ...
        if (modelPart.equals("bayonet_attachment") || modelPart.equals("player_bayonet")
    ...
    public IIcon getReplacementIcon(ItemStack shader, ItemStack item, String modelPart, int pass) {
        ...
        boolean hasUncoloured = modelPart.equals("barrel") || modelPart.equals("dev_scope")
            || modelPart.equals("player_mag")
