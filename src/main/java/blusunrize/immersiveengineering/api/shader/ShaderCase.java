 ...
 *         Pre-configured ones exist (ShaderCaseRevolver.class) but when a new, shader-ready item is implemented, it'll
 *         need a shadercase.
 */
public abstract class ShaderCase {
    ...
    /**
     * @return which icon is to be used for the given pass and model part. These obviously need to be stitched on the
     *         given sheet (mind the revolvers!)
     */
