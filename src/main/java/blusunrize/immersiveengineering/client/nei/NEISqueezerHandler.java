...
public class NEISqueezerHandler extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        ...
        for (SqueezerRecipe r : DieselHandler.squeezerList)
            if (r != null) if (outputId == getOverlayIdentifier()) this.arecipes.add(new CachedSqueezerRecipe(r));
    ...
    public void loadCraftingRecipes(ItemStack result) {
        if (result != null) for (SqueezerRecipe r : DieselHandler.squeezerList)
            if (r != null && Utils.stackMatchesObject(result, r.output)) this.arecipes.add(new CachedSqueezerRecipe(r));
    }
