...
public class NEIRefineryHandler extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId == getOverlayIdentifier()) for (RefineryRecipe r : DieselHandler.refineryList)
        ...
        if (fs != null) for (RefineryRecipe r : DieselHandler.refineryList)
    ...
    public boolean keyTyped(GuiRecipe gui, char keyChar, int keyCode, int recipe) {
        ...
        if (r != null) {
            ...
            FluidStack fs = null;
            if (localPoint.x > gl + 12 && localPoint.x <= gl + 12 + 16
                && localPoint.y > gt + (64 * (recipe % 2)) + 11
                && localPoint.y <= gt + (64 * (recipe % 2)) + 11 + 47) fs = r.fluid0;
            else if (localPoint.x > gl + 60 && localPoint.x <= gl + 60 + 16
                && localPoint.y > gt + (64 * (recipe % 2)) + 11
                && localPoint.y <= gt + (64 * (recipe % 2)) + 11 + 47) fs = r.fluid1;
            else if (localPoint.x > gl + 108 && localPoint.x <= gl + 108 + 16
                && localPoint.y > gt + (64 * (recipe % 2)) + 11
                && localPoint.y <= gt + (64 * (recipe % 2)) + 1 + 47) fs = r.fluidOut;

            if (fs != null) if (keyCode == NEIClientConfig.getKeyBinding("gui.recipe")) {
    ...
    public List<String> handleTooltip(GuiRecipe gui, List<String> list, int recipe) {
        ...
        if (r != null) {
            ...
            if (r.fluid0 != null && localPoint.x > gl + 12
            ...
            if (r.fluid1 != null && localPoint.x > gl + 60
            ...
            if (r.fluidOut != null && localPoint.x > gl + 108
