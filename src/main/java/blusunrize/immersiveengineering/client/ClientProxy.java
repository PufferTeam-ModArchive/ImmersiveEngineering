...
public class ClientProxy extends CommonProxy {
    ...
    public static final ResourceLocation revolverTextureResource = new ResourceLocation(
        "textures/atlas/immersiveengineering/revolvers.png");
    ...
    public void init() {
        ...
        ClientRegistry
            .bindTileEntitySpecialRenderer(TileEntityConnectorStructural.class, new TileRenderConnectorStructural());
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityBlastFurnacePreheater.class,
            new TileRenderBlastFurnacePreheater());
        // MULTIBLOCKS
        ...
        ClientRegistry
            .bindTileEntitySpecialRenderer(TileEntityWindmillAdvanced.class, new TileRenderWindmillAdvanced());
        ...
        ClientRegistry
            .bindTileEntitySpecialRenderer(TileEntityBlastFurnaceAdvanced.class, new TileRenderBlastFurnaceAdvanced());
        // CLOTH
        ...
        RenderingRegistry
            .registerEntityRenderingHandler(EntityChemthrowerShot.class, new EntityRenderChemthrowerShot());
        // VOLTMETER
        ...
        VillagerRegistry.instance()
            .registerVillagerSkin(
                villagerId,
                new ResourceLocation("immersiveengineering:textures/models/villager_engineer.png"));
    ...
    public void postInit() {
        ...
        int maxSubVersion = 0;
        while (!(ManualHelper.ieManualInstance.formatEntryName("updateNews_" + maxSubVersion)
        ...
        for (int subVersion = (maxSubVersion - 1); subVersion >= 0; subVersion--) {
            ...
            int i = 0;
            String key;
            while (!ManualHelper.ieManualInstance.formatText(key = "updateNews_" + subVersion + "" + i)
                .equals(key) && i < 5) {
                pages.add(new ManualPages.Text(ManualHelper.getManual(), key));
                i++;
            }
            ManualHelper.addEntry(
                "updateNews_" + subVersion,
        ...
        if (!IERecipes.hammerCrushingList.isEmpty()) {
            for (String ore : IERecipes.hammerCrushingList) recipes.add(
                new PositionedItemStack[] { new PositionedItemStack(OreDictionary.getOres("ore" + ore), 24, 0),
            ...
            if (!recipes.isEmpty()) ManualHelper.addEntry(
                "oreProcessing",
                ManualHelper.CAT_GENERAL,
        ...
        ManualHelper.addEntry(
            ...
            new ManualPages.CraftingMulti(
                ManualHelper.getManual(),
                "alloys0",
                (Object[]) new PositionedItemStack[][] {
                    new PositionedItemStack[] { new PositionedItemStack(OreDictionary.getOres("dustCopper"), 24, 0),
                    ...
                    new PositionedItemStack[] { new PositionedItemStack(OreDictionary.getOres("dustGold"), 24, 0),
        ...
        ManualHelper.addEntry(
            ...
            new ManualPages.CraftingMulti(
                ...
                "plates0",
                (Object[]) new PositionedItemStack[][] {
                    new PositionedItemStack[] { new PositionedItemStack(OreDictionary.getOres("ingotIron"), 24, 0),
                        new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                        new PositionedItemStack(new ItemStack(IEContent.itemMetal, 1, 30), 78, 0) },
                    new PositionedItemStack[] { new PositionedItemStack(OreDictionary.getOres("ingotAluminum"), 24, 0),
                        new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                        new PositionedItemStack(new ItemStack(IEContent.itemMetal, 1, 32), 78, 0) },
                    new PositionedItemStack[] { new PositionedItemStack(OreDictionary.getOres("ingotLead"), 24, 0),
                        new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
                    ...
                    new PositionedItemStack[] { new PositionedItemStack(OreDictionary.getOres("ingotSteel"), 24, 0),
                        new PositionedItemStack(new ItemStack(IEContent.itemTool, 1, 0), 42, 0),
        ...
        ManualHelper.addEntry(
            ...
            new ManualPages.Crafting(
                ManualHelper.getManual(),
                "cokeovenBlock",
                new ItemStack(IEContent.blockStoneDecoration, 1, 1)),
        ...
        ShaderRegistry.manualEntry = ManualHelper.getManual()
            .getEntry("shader");
        ...
        ManualHelper.addEntry(
            ...
            new ManualPages.Crafting(
                ManualHelper.getManual(),
                "metalconstruction2",
                new ItemStack(IEContent.blockMetalDecoration, 1, BlockMetalDecoration.META_connectorStructural)),
            new ManualPages.Crafting(
                ManualHelper.getManual(),
                "",
        ...
        ManualHelper.addEntry(
            ...
            new ManualPages.Crafting(
                ManualHelper.getManual(),
                "balloon0",
                new ItemStack(IEContent.blockClothDevice, 1, 0)),
        ...
        Map.Entry<String, Integer>[] dieselFuels = sortedMap.entrySet()
        ...
        ManualHelper.addEntry(
            ...
            new ManualPageMultiblock(
                ManualHelper.getManual(),
                "improvedBlastfurnace1",
                MultiblockBlastFurnaceAdvanced.instance),
        ...
        ManualHelper.addEntry(
            ...
            new ManualPages.CraftingMulti(
                ManualHelper.getManual(),
                "metalPress2",
                (Object[]) stacks.toArray(new ItemStack[stacks.size()])));
        ManualHelper.addEntry(
            "assembler",
            ManualHelper.CAT_HEAVYMACHINES,
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == Lib.GUIID_Manual && ManualHelper.getManual() != null
            && player.getCurrentEquippedItem() != null
            && OreDictionary
                .itemMatches(new ItemStack(IEContent.itemTool, 1, 3), player.getCurrentEquippedItem(), false))
            return ManualHelper.getManual()
                .getGui();
    ...
    public void handleTileSound(String soundName, TileEntity tile, boolean tileActive, float volume, float pitch) {
        ...
        if (sound != null) {
            ...
            sound = ClientUtils.generatePositionedIESound(
                "immersiveengineering:" + soundName,
                volume,
                pitch,
                true,
                0,
    ...
    public void stopTileSound(String soundName, TileEntity tile) {
        IESound sound = soundMap.get(soundName);
        if (sound != null && sound.getXPosF() == tile.xCoord
    ...
    public void spawnCrusherFX(TileEntityCrusher tile, ItemStack stack) {
        if (stack != null) for (int i = 0; i < 3; i++) {
            ...
            if (stack.getItem()
                ...
                particle = new EntityFXBlockParts(
                    tile.getWorldObj(),
                    stack,
                    tile.getWorldObj().rand.nextInt(16),
                    x,
                    y,
                    z,
                    mX,
                    mY,
                    mZ);
            else particle = new EntityFXItemParts(
                tile.getWorldObj(),
                stack,
                tile.getWorldObj().rand.nextInt(16),
                x,
    ...
    public void draw3DBlockCauldron() {
        ...
        blockRender
            .renderFaceYPos(Blocks.cauldron, (double) 0, (double) ((float) 0 - 1.0F + 0.25F), (double) 0, iicon1);
        blockRender
            .renderFaceYNeg(Blocks.cauldron, (double) 0, (double) ((float) 0 + 1.0F - 0.75F), (double) 0, iicon1);
        Tessellator.instance.addTranslation(.5f, .5f, .5f);
        Tessellator.instance.draw();
    }

    static String[][] formatToTable_ItemIntHashmap(Map<String, Integer> map, String valueType) {
        Map.Entry<String, Integer>[] sortedMapArray = map.entrySet()
            .toArray(new Map.Entry[0]);
        ...
        try {
            for (int i = 0; i < sortedMapArray.length; i++) {
                ...
                if (ApiUtils.isExistingOreName(sortedMapArray[i].getKey())) {
                    ItemStack is = OreDictionary.getOres(sortedMapArray[i].getKey())
                        .get(0);
                    if (is != null) item = is.getDisplayName();
                } else if (sortedMapArray[i].getKey()
                    .contains("::")) {
                        String[] split = sortedMapArray[i].getKey()
                            .split("::");
                        Item it = GameData.getItemRegistry()
                            .getObject(split[0]);
                        int meta = 0;
                        try {
    ...
    public String[] splitStringOnWidth(String s, int w) {
        return ((List<String>) ClientUtils.font()
            .listFormattedStringToWidth(s, w)).toArray(new String[0]);
    }
