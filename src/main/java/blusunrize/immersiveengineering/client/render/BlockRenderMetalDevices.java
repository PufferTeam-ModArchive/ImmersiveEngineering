        ...
        if (metadata == BlockMetalDevices.META_connectorLV) {
            ...
            if (metadata == BlockMetalDevices.META_conveyorBelt || metadata == BlockMetalDevices.META_conveyorDropper) {
                ...
                if (te1 instanceof TileEntityConveyorBelt) {
                    ...
                    f = tile.facing;
                    y00 = tile.transportUp ? (f == 5 || f == 3 ? 1 : 0)
                        : tile.transportDown ? (f == 4 || f == 2 ? 1 : 0) : 0;
                    y01 = tile.transportUp ? (f == 5 || f == 2 ? 1 : 0)
                        : tile.transportDown ? (f == 4 || f == 3 ? 1 : 0) : 0;
                    y11 = tile.transportUp ? (f == 4 || f == 2 ? 1 : 0)
                        : tile.transportDown ? (f == 5 || f == 3 ? 1 : 0) : 0;
                    y10 = tile.transportUp ? (f == 4 || f == 3 ? 1 : 0)
                ...
                if (f == 2 || f == 3) {
                    if (!connectedBelts[2]) {
                        vs = new Vec3[] { Vec3.createVectorHelper(0, y00, 0), Vec3.createVectorHelper(0, y01, 1),
                            Vec3.createVectorHelper(.0625, y10, 0), Vec3.createVectorHelper(.0625, y11, 1),
                            Vec3.createVectorHelper(0, y00 + .1875, 0), Vec3.createVectorHelper(0, y01 + .1875, 1),
                            Vec3.createVectorHelper(.0625, y10 + .1875, 0),
                            Vec3.createVectorHelper(.0625, y11 + .1875, 1) };
                        ClientUtils.drawWorldSubBlock(renderer, world, block, x, y, z, vs);
                    }
                    if (!connectedBelts[3]) {
                        vs = new Vec3[] { Vec3.createVectorHelper(.9375, y00, 0),
                            Vec3.createVectorHelper(.9375, y01, 1), Vec3.createVectorHelper(1, y10, 0),
                            Vec3.createVectorHelper(1, y11, 1), Vec3.createVectorHelper(.9375, y00 + .1875, 0),
                            Vec3.createVectorHelper(.9375, y01 + .1875, 1), Vec3.createVectorHelper(1, y10 + .1875, 0),
                            Vec3.createVectorHelper(1, y11 + .1875, 1) };
                        ClientUtils.drawWorldSubBlock(renderer, world, block, x, y, z, vs);
                    }
                } else if (f == 4 || f == 5) {
                    if (!connectedBelts[0]) {
                        vs = new Vec3[] { Vec3.createVectorHelper(0, y00, 0), Vec3.createVectorHelper(0, y01, .0625),
                            Vec3.createVectorHelper(1, y10, 0), Vec3.createVectorHelper(1, y11, .0625),
                            Vec3.createVectorHelper(0, y00 + .1875, 0), Vec3.createVectorHelper(0, y01 + .1875, .0625),
                            Vec3.createVectorHelper(1, y10 + .1875, 0),
                            Vec3.createVectorHelper(1, y11 + .1875, .0625) };
                        ClientUtils.drawWorldSubBlock(renderer, world, block, x, y, z, vs);
                    }
                    if (!connectedBelts[1]) {
                        vs = new Vec3[] { Vec3.createVectorHelper(0, y00, .9375), Vec3.createVectorHelper(0, y01, 1),
                            Vec3.createVectorHelper(1, y10, .9375), Vec3.createVectorHelper(1, y11, 1),
                            Vec3.createVectorHelper(0, y00 + .1875, .9375), Vec3.createVectorHelper(0, y01 + .1875, 1),
