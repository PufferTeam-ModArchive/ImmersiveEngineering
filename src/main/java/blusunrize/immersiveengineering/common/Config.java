...
public class Config {
    ...
    public static void init(FMLPreInitializationEvent event) {
        ...
        if (lastVersion < currentVersion) {
            ...
            if (lastVersion < .6) {
                ...
                config.getCategory("general")
                    .remove("Cable transfer rates");
                config.getCategory("general")
                    .remove("Cable loss");
            }
            if (lastVersion < .61) {
                IELogger.info("The config on bullet damage will be reset to the default.");
                config.getCategory("tools")
                    .remove("BulletDamage-Casull");
                config.getCategory("tools")
                    .remove("BulletDamage-AP");
                config.getCategory("tools")
                    .remove("BulletDamage-Buck");
                config.getCategory("tools")
                    .remove("BulletDamage-Dragon");
                config.getCategory("tools")
                    .remove("BulletDamage-Homing");
                config.getCategory("tools")
                    .remove("BulletDamage-Wolfpack");
                config.getCategory("tools")
                    .remove("BulletDamage-WolfpackPart");
                config.getCategory("tools")
                    .remove("BulletDamage-Silver");
                config.getCategory("tools")
                    .remove("BulletDamage-Potion");
            }
            config.getCategory("general")
                .remove("Show Update News");
        }
        ...
        cableProperty = config
            .get("general", "Cable colouration", new int[] { 0xd4804a, 0xedad62, 0x6f6f6f, 0x967e6d, 0x6f6f6f }, "");
        ...
        setBoolean(
            "showUpdateNews",
            config.get("general", "Show Update News", true, "Set this to false to hide the update news in the manual")
                .getBoolean());
        setStringArray(
            "blacklistBosses",
            config.get(
        ...
        setDouble(
            "BulletDamage-AP",
            config.get("tools", "BulletDamage-AP", 10d, "The amount of base damage an ArmorPiercing Cartridge inflicts")
                .getDouble());
        setDouble(
            "BulletDamage-Buck",
            config.get("tools", "BulletDamage-Buck", 2d, "The amount of base damage a single part of Buckshot inflicts")
                .getDouble());
        setDouble(
            "BulletDamage-Dragon",
            config
                .get("tools", "BulletDamage-Dragon", 3d, "The amount of base damage a DragonsBreath Cartridge inflicts")
                .getDouble());
        setDouble(
            "BulletDamage-Homing",
        ...
        setDouble(
            ...
            config.get("tools", "BulletDamage-Wolfpack", 6d, "The amount of base damage a Wolfpack Cartridge inflicts")
                .getDouble());
        setDouble(
        ...
        ItemJerrycan.blacklist = Sets.newHashSet(
            config.get(
                "tools",
                "Jerrycan Blacklist",
                new String[] {},
        ...
        for (String key : IECompatModule.moduleClasses.keySet()) setBoolean(
            "compat_" + key,
            config
                .get(
                    "compatability",
    ...
    public static int getPotionID(int base, String key) {
        // config.load();
        int i = config
            .get("potions", key, IEPotions.getNextPotionId(base), "The potion ID for the " + key + " potion effect")
            .getInt();
        config.save();
        return i;
    }
