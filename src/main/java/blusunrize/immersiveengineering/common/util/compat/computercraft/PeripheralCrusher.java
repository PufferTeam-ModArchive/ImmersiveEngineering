...
public class PeripheralCrusher extends IEPeripheral {
    ...
    public static final String[] cmds = { "getQueueLength", "setEnabled", "isActive", "getInputStack",
        "getCurrentMaxProgress", "getCurrentProgress", "getMaxEnergyStored", "getEnergyStored" };
