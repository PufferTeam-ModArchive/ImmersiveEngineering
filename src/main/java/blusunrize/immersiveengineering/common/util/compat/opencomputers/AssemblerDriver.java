...
public class AssemblerDriver extends DriverTileEntity {
    ...
    public class AssemblerEnvironment extends ManagedEnvironmentIE<TileEntityAssembler> {
        ...
        @Callback(
            doc = "function(recipe:int):boolean -- get whether the ingredients for the specified recipe are available")
        ...
        @Callback(
            doc = "function(recipe:int):boolean -- check whether the recipe in the specified position has an output")
