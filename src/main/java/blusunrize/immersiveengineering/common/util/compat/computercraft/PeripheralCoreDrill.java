...
public class PeripheralCoreDrill extends IEPeripheral {
    ...
    public static final String[] cmds = { "getSampleProgress", "isSamplingFinished", "getVeinUnlocalizedName",
        "getVeinLocalizedName", "getVeinIntegrity", "getEnergyStored", "getMaxEnergyStored" };
