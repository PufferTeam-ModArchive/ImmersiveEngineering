...
public class PeripheralRefinery extends IEPeripheral {
    ...
    public static final String[] cmds = { "getInputFluidTanks", "getOutputTank", "getRecipe", "setEnabled",
        "isValidRecipe", "getEmptyCannisters", "getFullCannisters", "getMaxEnergyStored", "getEnergyStored" };
