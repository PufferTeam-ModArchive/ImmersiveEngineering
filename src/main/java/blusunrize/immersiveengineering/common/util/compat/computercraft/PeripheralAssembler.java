...
public class PeripheralAssembler extends IEPeripheral {
    ...
    public static final String[] cmds = { "hasIngredients", "setEnabled", "getRecipe", "isValidRecipe", "getTank",
        "getMaxEnergyStored", "getEnergyStored", "getStackInSlot", "getBufferStack" };
