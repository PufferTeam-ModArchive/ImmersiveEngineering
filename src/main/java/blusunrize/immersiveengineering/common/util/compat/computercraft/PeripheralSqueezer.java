...
public class PeripheralSqueezer extends IEPeripheral {
    ...
    public static final String[] cmds = { "getRecipe", "getInputStack", "getOutputStack", "getFluid",
        "getEmptyCannisters", "getFilledCannisters", "getEnergyStored", "getMaxEnergyStored", "getProgress" };
    ...
    public Object[] callMethod(IComputerAccess computer, ILuaContext context, int method, Object[] arguments)
        ...
        switch (method) {
            case 0: // recipe
                ...
                if (recipe != null) return new Object[] { saveStack(te.getStackInSlot(slot - 1)),
                    saveStack(recipe.output), saveFluidStack(recipe.fluid), recipe.time };
