...
public abstract class IESlot extends Slot {
    ...
    public static class Output extends IESlot {
        ...
        public void onPickupFromSlot(EntityPlayer player, ItemStack stack) {
            ...
            if (player != null
                && (this.container instanceof ContainerBlastFurnace || this.container instanceof ContainerArcFurnace)
    ...
    public static class Upgrades extends IESlot {
        ...
        public Upgrades(Container container, IInventory inv, int id, int x, int y, String type,
            ItemStack upgradeableTool, boolean preventDoubles) {
            super(container, inv, id, x, y);
            this.type = type;
        ...
        @Override
        public boolean isItemValid(ItemStack itemStack) {
            if (preventDoubles) for (Slot slot : (List<Slot>) container.inventorySlots)
                if (slot instanceof IESlot.Upgrades && ((IESlot.Upgrades) slot).preventDoubles
            ...
            return itemStack != null && itemStack.getItem() instanceof IUpgrade
                && ((IUpgrade) itemStack.getItem()).getUpgradeTypes(itemStack)
                    .contains(type)
    ...
    public static class Shader extends IESlot {
        ...
        public Shader(Container container, IInventory inv, int id, int x, int y, ItemStack tool) {
            ...
            if (FMLCommonHandler.instance()
                .getEffectiveSide() == Side.CLIENT) this.setBackgroundIcon(IEContent.itemShader.icons[3]);
        }

        @Override
        public boolean isItemValid(ItemStack itemStack) {
            if (itemStack == null || !(itemStack.getItem() instanceof IShaderItem)
                || tool == null
                || !(tool.getItem() instanceof IShaderEquipableItem)) return false;
            return ((IShaderItem) itemStack.getItem())
                .getShaderCase(itemStack, tool, ((IShaderEquipableItem) tool.getItem()).getShaderType()) != null;
        }
    ...
    public static class UpgradeableItem extends IESlot {
        ...
        @Override
        public boolean isItemValid(ItemStack itemStack) {
            return itemStack != null && itemStack.getItem() instanceof IUpgradeableTool
        ...
        public boolean canTakeStack(EntityPlayer player) {
            if (this.getStack() != null && getStack().getItem() instanceof IUpgradeableTool
    ...
    public static class BlueprintOutput extends IESlot {
        ...
        public BlueprintOutput(Container container, IInventory inv, int id, int x, int y, ItemStack upgradeableTool,
